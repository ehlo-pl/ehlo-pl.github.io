...
draft = true
description = "Note to Self - Mail Sender Authentication Protocols, and an Overview of SPF, DKIM, DMARC and others"
+++
...
**DISCLAIMER: part of that text was generated using Chat GPT 4, but all was proofreaded and manualy verifed.**