...
draft = true
description = "Note to self - PowerShell and user folders in Windows"
+++
...
or for enumerate all of them: ```[enum]::GetNames( [System.Environment+SpecialFolder] )``` (spaces between [,] and ( ) are in some version of PS1 important).
